...
using WpfFaceMatch.Models.Win32;

namespace WpfFaceMatch.Views.Chrome
{
	/// <summary>
	/// <see cref="T:WpfFaceMatch.Views.Chrome.GlowWindow"/>
	/// の各種座標を計算します。
	/// </summary>
	internal abstract class GlowWindowProcessor
	{
		...
		/// <summary>
		/// 派生クラスでオーバーライドされると、<see cref="T:WpfFaceMatch.Views.Chrome.GlowWindow"/>
