...
{
    class UcommHearerTwoSearch : AbstractUcommHearer
    {
		//中継するデリゲート
        ...
        public UcommHearerTwoSearch(_ISpeechRecoContextEvents_RecognitionEventHandler rec, _ISpeechRecoContextEvents_FalseRecognitionEventHandler falseRec)
        {
            this.Recognition = rec;
            this.FalseRecognition = falseRec;

			keywordList.Add("検索");	// 0
            keywordList.Add("履歴");	// 1
            keywordList.Add("戻る");
